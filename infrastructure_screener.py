...
# ============================================================
# INFRASTRUCTURE / TELECOM SCREENER V1
# ============================================================
...
if len(df) == 0:
    ...
    print("\n")
    print("=" * 70)
    print("        HASIL INFRASTRUCTURE / TELECOM SCREENING")
    print("=" * 70)
    ...
    if len(df_pass) > 0:
        ...
        print("=" * 70)
        print("       KANDIDAT INFRASTRUCTURE / TELECOM #1")
        print("=" * 70)
    ...
    print("\n")
    print("=" * 70)
    print("       INFRASTRUCTURE SCREENER V1 SELESAI")
    print("=" * 70)